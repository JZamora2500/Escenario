...
public class MyCanvas extends GLCanvas implements GLEventListener, KeyListener {
    ...
    public static final int FPS = 40; // animator's target frames per second
    ...
    public void init(GLAutoDrawable glad) {
        ...
        try {
            obj3 = or.Load("./data/Futuristic Apartment.obj");
    ...
    public void display(GLAutoDrawable glad) {
        ...
        */
        ...
        if (obj1 != null) {
            obj1.draw(gl);
            gl.glTranslatef(200 , 20, 180);
            gl.glTranslatef(40 , 20 , -4);
        }
                    
        if (obj2 != null) {
            obj2.draw(gl);
             gl.glTranslatef(150, 10, 120);
             gl.glScalef(4, 4, 4);
        }
                
        if (obj3 != null) {
            obj3.draw(gl);
             gl.glTranslatef(200, 10, 20);
             gl.glScalef(-20 , -20, 4);
        }
